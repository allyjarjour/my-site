...
function loadEnv() {
	if (!existsSync(envPath)) {
		console.error(
			"Missing functions/.env. Add SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET first.",
		);
		process.exit(1);
	}
...
if (!clientId || !clientSecret) {
	console.error(
		"functions/.env must contain SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET.",
	);
	process.exit(1);
}
...
server.listen(8888, () => {
	console.log(
		"Open this URL in your browser, log in to Spotify, and approve access:\n",
	);
	console.log(authUrl);
